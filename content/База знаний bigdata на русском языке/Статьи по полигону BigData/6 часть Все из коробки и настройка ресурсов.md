...
![[Служебное. Вложения/poligon_airflow_dbt_enhanced_1.png]]
...
![[Служебное. Вложения/poligon_airflow_dbt_enhanced_2.png]]
```
...
![[Служебное. Вложения/poligon_airflow_dbt_enhanced_3.png]]
...
![[Служебное. Вложения/poligon_airflow_dbt_enhanced_4.png]]
Прогоняем наш DAG

![[Служебное. Вложения/poligon_airflow_dbt_enhanced_5.png]]
...
![[Служебное. Вложения/poligon_airflow_dbt_enhanced_6.png]]
  ...
  deploy:
    resources:
      ...
      reservations:
        ...
        memory: 2G
```
![[Служебное. Вложения/poligon_airflow_dbt_enhanced_7.png]]
