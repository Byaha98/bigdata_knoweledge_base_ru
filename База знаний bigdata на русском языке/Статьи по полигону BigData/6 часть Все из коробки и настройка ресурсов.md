...
Можно будет сразу развернуть все необходимые элементы из прошлых гайдов, игнорируя их.

Я сделал несколько нововведений в репозиторий полигона, чтобы можно было получить clickhouse-airflow-dbt сразу из коробки. 
...
DBT модель точно так же создалась
  ...
  deploy:
    resources:
      ...
      reservations:
        ...
        memory: 2G
```
![[poligon_airflow_dbt_enhanced_7.png]]Отлично! Настроили полигон для удобного и быстрого развертывания! Гооооооол